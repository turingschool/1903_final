...
class CuratorTest < Minitest::Test
  ...
  def test_that_it_can_add_photos
    curator = Curator.new
  ...
  def test_that_it_can_add_artist
    curator = Curator.new
  ...
  def test_artisd_with_multiple_photaographs
  curator = Curator.new
  photo_1 = Photograph.new({
     id: "1",
     name: "Rue Mouffetard, Paris (Boy with Bottles)",
  ...
  # assert_equal [photo_1,photo_3], curator.photographs_taken_between(1950..1965)
  end
end
